    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Text, { style: styles.quoteLabel }, 'QUOTATION'),
          React.createElement(
            Text,
            { style: styles.quoteNumber },
            quote.invoice_number || 'INV-DRAFT'
          ),
          React.createElement(Text, { style: styles.quoteDate }, quoteDate)
        )
      ),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          false ? 'Delivery Order' : 'Pickup Order'
        )
      ),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            false ? 'Delivery Details' : 'Pickup Details'
          ),
          false
            ? React.createElement(
                React.Fragment,
                ...
                quote.county
                  ...
                  : null,
                quote.courier_service
                  ? React.createElement(
                      Text,
                      { style: styles.infoLineMuted },
                      `Courier: ${quote.courier_service}`
                    )
                  : null,
      ...
      React.createElement(
        ...
        kraPin
          ? React.createElement(
              Text,
              { style: styles.paymentLine },
              `M-Pesa Paybill: ${kraPin}  |  Account No.: ${quote.invoice_number}`
            )
          : null,
 ...
 *
 * @param quote    - Full quote object with items and customer info
...
export async function generateQuotePDF(
  ...
  const doc = React.createElement(QuoteDocument, { quote, settings });

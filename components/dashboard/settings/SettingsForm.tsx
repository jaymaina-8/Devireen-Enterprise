    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSectionSave} className="max-w-4xl space-y-6">
        ...
        <div
          className={
            activeTab === 'company'
              ? 'animate-in fade-in space-y-6 rounded-2xl border border-slate-200/80 bg-white p-6 text-xs shadow-2xs duration-150'
              : 'hidden'
          }
        >
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="space-y-1.5">
              ...
              <p className="mt-1 text-[10px] text-slate-400">
                If disabled, VAT will not be calculated on quotes and invoices.
              </p>
            </div>
          </div>
        ...
        >
          <div className="border-b border-slate-100 pb-3">
            <h2 className="flex items-center gap-2 text-sm font-bold text-slate-900">
              <Clock className="h-4 w-4 text-emerald-600" /> Business Operating
              Hours
            </h2>
            <p className="mt-0.5 text-[11px] text-slate-500">
